...
def register(bl_info):
    ...
    updater.repo = 'BlenderToggleTools'
    # updater.addon = # define at top of module, MUST be done first

    # Website for manual addon download, optional but recommended to set.
    updater.website = 'https://github.com/SmittyWerbenJJ/BlenderToggleTools'
    ...
    updater.use_releases = False    # Note: Releases always have a tag, but a tag may not always be a release.
    ...
    updater.version_min_update = (0, 1, 0)    # updater.version_min_update = None  # None or default for no minimum.
